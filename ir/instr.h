...
public:
  ...
  static constexpr std::array<std::pair<unsigned, unsigned>, 9> shape_op0 = {
  ...
  static constexpr std::array<std::pair<unsigned, unsigned>, 9> shape_op1 = {
  /* sse2_psrl_w */       std::make_pair(8, 16),
  /* sse2_psrl_d */       std::make_pair(4, 32),
  /* sse2_psrl_w */       std::make_pair(2, 64),
  ...
  static constexpr std::array<std::pair<unsigned, unsigned>, 9> shape_ret = {
  /* sse2_psrl_w */       std::make_pair(8, 16),
  /* sse2_psrl_d */       std::make_pair(4, 32),
  /* sse2_psrl_w */       std::make_pair(2, 64),
  /* avx2_psrl_w */       std::make_pair(16, 16),
